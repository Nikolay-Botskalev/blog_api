# api_final
1. Описание
    Проект yatube_api представляет собой платформу для людей, ведущих свои блоги. В нем можно зарегистрироваться, создавать записи, просматривать чужие записи, оставлять комментарии к записям и подписываться на других людей. Обмен данными осуществляется через API.
